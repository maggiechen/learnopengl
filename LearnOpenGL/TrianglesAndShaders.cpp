...
void TrianglesAndShaders::ValidateShader(const unsigned int shaderId)
{
	int success;
	char infoLog[512];
...
unsigned int TrianglesAndShaders::createBasicShaderProgram(std::string fragColorString) {
...
/// a rectangle
/// </summary>
int TrianglesAndShaders::mainImplRectangleWithEBO() {
